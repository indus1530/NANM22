...
import edu.aku.abdulsajid.nanm2022.databinding.ActivitySectionC5Binding;
...
public class SectionC5Activity extends AppCompatActivity {
    ...
    private boolean updateDB() {
        ...
        int updcount = 0;
        try {
            //updcount = db.updatesAdolColumn(TableContracts.AdolescentTable.COLUMN_SC5, adol.sC5toString());
            Adolescent adol = MainApp.adol;
            adol.setSC5(MainApp.adol.sC5toString());
