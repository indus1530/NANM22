...
import edu.aku.abdulsajid.nanm2022.databinding.ActivitySectionC6Binding;
...
public class SectionC6Activity extends AppCompatActivity {
    ...
    private boolean updateDB() {
        ...
        int updcount = 0;
        try {
            //updcount = db.updatesAdolColumn(TableContracts.AdolescentTable.COLUMN_SC6, adol.sC6toString());
            Adolescent adol = MainApp.adol;
            adol.setSC6(MainApp.adol.sC6toString());
