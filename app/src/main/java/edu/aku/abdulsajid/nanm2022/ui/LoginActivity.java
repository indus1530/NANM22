...
import static edu.aku.abdulsajid.nanm2022.core.CipherSecure.decryptGCM;
import static edu.aku.abdulsajid.nanm2022.core.CipherSecure.encryptGCM;
import static edu.aku.abdulsajid.nanm2022.core.CipherSecure.hashSHA256;
   ...
   /* private int PhotoSerial = 0;
    ...
    public void onSyncDataClick(View view) {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            startActivity(new Intent(this, edu.aku.abdulsajid.nanm2022.ui.SyncActivity.class).putExtra("login", true));
        } else {
